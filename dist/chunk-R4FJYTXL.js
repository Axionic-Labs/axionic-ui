...
function DarkSection({
  ...
  return /* @__PURE__ */ jsx(
    "section",
    {
      ...
      ...props,
      children: /* @__PURE__ */ jsx("div", { className: cn("mx-auto px-6 lg:px-8", sizeMap[size]), children })
    }
  );
}
function PageHeader({
...
function Section({
  ...
  return /* @__PURE__ */ jsx("section", { className: cn(!noPadding && "py-20 md:py-28", className), ...props, children: /* @__PURE__ */ jsx("div", { className: cn("mx-auto px-6 lg:px-8", sizeMap2[size]), children }) });
}
var ratioMap = {
...
//# sourceMappingURL=chunk-R4FJYTXL.js.map
//# sourceMappingURL=chunk-R4FJYTXL.js.map