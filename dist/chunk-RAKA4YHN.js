import { Card, CardContent } from './chunk-BYBIBCJJ.js';
...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      ...props,
      children: [
        icon && /* @__PURE__ */ jsx("div", { className: "mb-4", style: { color: "var(--color-teal-300)" }, children: icon }),
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold mb-2", style: { color: "var(--color-rich-black)" }, children: title }),
        description && /* @__PURE__ */ jsx("p", { className: "text-sm max-w-sm", style: { color: "var(--color-teal-700)" }, children: description }),
...
function FeatureCard({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("feature-hover rounded-xl p-4 md:p-5 text-center", className), ...props, children: [
    icon && /* @__PURE__ */ jsx("div", { className: "mb-3", children: icon }),
    /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold mb-1", style: { color: "var(--color-rich-black)" }, children: title }),
    /* @__PURE__ */ jsx("p", { className: "text-xs leading-relaxed", style: { color: "var(--color-teal-700)" }, children: description })
  ] });
}
var variantStyles = {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "text-base font-bold mb-2", style: { color: "var(--color-rich-black)" }, children: title }),
        description && /* @__PURE__ */ jsx("p", { className: "text-sm leading-relaxed", style: { color: "var(--color-teal-700)" }, children: description })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-RAKA4YHN.js.map
//# sourceMappingURL=chunk-RAKA4YHN.js.map